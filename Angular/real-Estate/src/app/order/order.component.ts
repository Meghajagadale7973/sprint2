...
export class OrderComponent implements OnInit { 
 ...
 this.httpc.post("https://localhost:44371/api/Order",Orderdto).subscribe(res=>this.PostSuccess(res),res=>this.PostError(res));
 this.TblOrderModel = new TblOrder();
  ...
  getOrder(){
    console.log("Hi");
    this.httpc.get("https://localhost:44371/api/Order").subscribe(res=>this.GetSuccess(res),res=>this.GetError(res));
